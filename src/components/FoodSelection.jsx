...
const FoodSelection = ({ selectedCity, onBackToMap, onFoodClick }) => {
  ...
  return (
    ...
    >
      ...
      <h2 className="section-title">{cityData.name}의 특산 음식</h2>
      <p className="section-description">맛있는 음식을 선택해보세요!</p>
      
      <div className="foods-grid">
        {Object.entries(cityData.foods).map(([foodKey, food], index) => (
          <motion.div
            key={foodKey}
            className="food-card"
            onClick={() => onFoodClick(foodKey)}
